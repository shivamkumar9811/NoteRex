...
/**
 * NextAuth options - separated so getSession() does not trigger NextAuth() init.
 * Add Google only when env vars are set (avoids 500 on Vercel when they are missing).
 */
const providers = [
